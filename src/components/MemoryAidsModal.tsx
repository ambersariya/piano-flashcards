  ...
  return (
    <>
      ...
      <div className="fixed inset-4 sm:inset-auto sm:left-1/2 sm:top-1/2 sm:-translate-x-1/2 sm:-translate-y-1/2 sm:w-full sm:max-w-2xl z-50">
        <div className="rounded-lg bg-zinc-900 p-6 border border-zinc-800 max-h-[90vh] overflow-y-auto">
          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 mb-4">
            <div className="rounded-md bg-blue-500/10 p-3 border border-blue-400/20">
          ...
          <div className="rounded-md bg-white/5 px-3 py-2 text-xs text-zinc-300 border border-white/10">
